    ...
    try:
        ...
        while True:
            ...
            try:
                ...
                query_request = QueryRequest(**request_data)  # Validate with Pydantic
        ...
        if heartbeat_task:
            await asyncio.sleep(0.1)  # Add the delay here
